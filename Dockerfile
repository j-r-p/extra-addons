...
# Install htmltotext dependency
RUN pip3 install html2text

# Install Odoo
ENV ODOO_VERSION 16.0
#ARG ODOO_RELEASE=20260228
#ARG ODOO_SHA=0f850e49a2ed6bb6c8b09b43a21005d3cc5e72ab
...
# Setting up msn addons dir

RUN mkdir -p /mnt/msn-addons
COPY ./extra-addons /mnt/msn-addons
RUN ls -la /mnt/msn-addons
RUN chown -R odoo /mnt/msn-addons
